...
public class CheckmateDrive extends MecanumDrive {
    // VISION STUFF
    public enum OrangeLevel {FOUR, ONE, NONE}

    private final ColorIntensityPipeline pipeline = new ColorIntensityPipeline();
    ...
    */
    ...
    private static class ColorIntensityPipeline extends OpenCvPipeline {
        ...
        private volatile OrangeLevel position = OrangeLevel.FOUR;
        ...
        public Mat processFrame(Mat input) {
            ...
            position = OrangeLevel.FOUR; // Record our analysis
            if (avg1 > VisionHelper.FourRingThresh) {
                position = OrangeLevel.FOUR;
            } else if (avg1 > VisionHelper.OneRingThresh) {
                position = OrangeLevel.ONE;
            } else {
                position = OrangeLevel.NONE;
            }
        ...
        public OrangeLevel getPosition(){
            return position;
        }
    }
