...
@Autonomous
public class SharedRed extends BasicOpMode {
    ...
    public void setup() {
        ...
        TrajectorySequence toSharedRed = robot.drivetrain.trajectorySequenceBuilder(new Pose2d(10, -61, Math.toRadians(90)))
